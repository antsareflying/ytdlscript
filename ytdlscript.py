...
ytdl_command = f"yt-dlp --write-description --write-info-json --write-annotations --write-sub --write-thumbnail --no-playlist --download-archive C:/users/seong/archive/public/videos/downloadedarchive.txt -f mp4 -o \"C:/users/seong/archive/public/videos/%(release_date)s-%(title)s-%(id)s.%(ext)s\" {ytlink}"
